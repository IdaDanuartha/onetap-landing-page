...
export function UseCases() {
  return (
    ...
    >
      ...
      />
      {/* Glow blobs */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#FF5FA2] rounded-full opacity-12 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-72 h-72 bg-[#F6B7C8] rounded-full opacity-8 blur-[100px] pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-2 relative">
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-xl border border-[#FF5FA2]/20 rounded-2xl p-5">
              <div className="text-white text-3xl mb-1" style={{ fontFamily: "var(--font-display)", fontWeight: 800 }}>
                20+ Industries
              </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="text-white text-sm font-semibold mb-1" style={{ fontFamily: "var(--font-display)" }}>
                        {uc.title}
                      </h3>
