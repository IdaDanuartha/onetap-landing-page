    ...
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#FF5FA2]/30 bg-[#FF5FA2]/10 backdrop-blur-sm mb-8">
              ...
              <span className="text-sm text-[#F6B7C8] font-medium">New: Smart NFC Cards Now Available</span>
            </div>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
          <path d="M0 40L60 45C120 50 240 60 360 65C480 70 600 70 720 65C840 60 960 50 1080 45C1200 40 1320 40 1380 40L1440 40V80H1380C1320 80 1200 80 1080 80C960 80 840 80 720 80C600 80 480 80 360 80C240 80 120 80 60 80H0V40Z" fill="white"/>
        </svg>
      </div>
    </section>
  );
