    ...
    <div className="relative rounded-[2rem] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 text-center shadow-2xl shadow-[#FF5FA2]/10 border border-[#F6B7C8]/30 max-w-sm mx-4">
          ...
          <Link
            href="/#pricing"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#FF5FA2] to-[#E8457E] text-white font-bold text-sm shadow-lg shadow-[#FF5FA2]/20 hover:-translate-y-0.5 transition-all"
          >
            Upgrade Plan
