...
export default function LinktreeHighlight() {
  const { t } = useLanguage();
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: '-80px' });

  const featureItems = [
    { icon: Link2, label: t('linktree.features.links'), color: '#FF5FA2', bg: '#FFF8F2' },
    { icon: Palette, label: t('linktree.features.themes'), color: '#FF5FA2', bg: '#FFF8F2' },
    { icon: BarChart2, label: t('linktree.features.analytics'), color: '#FF5FA2', bg: '#FFF8F2' },
    { icon: Wifi, label: t('linktree.features.nfc'), color: '#FF5FA2', bg: '#FFF8F2' },
  ];

  // Mini preview links for mockup
  const previewLinks = [
    { icon: Instagram, label: 'Instagram' },
    { icon: Briefcase, label: t('linktree.mockup.portfolio') },
    { icon: Mail, label: t('linktree.mockup.email') },
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#F6B7C8] bg-[#FFF8F2] mb-6 shadow-sm">
              ...
              <span className="text-sm font-semibold text-[#FF5FA2]">{t('linktree.badge')}</span>
            </div>
            ...
            >
              {t('linktree.title1')}
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF5FA2] to-[#E8457E]">{t('linktree.title2')}</span>
            </h2>
